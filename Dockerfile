...
WORKDIR /src
COPY ["Web8.csproj", "."]
RUN dotnet restore "./Web8.csproj"
COPY . .
WORKDIR "/src/."
RUN dotnet build "./Web8.csproj" -c $BUILD_CONFIGURATION -o /app/build

# Diese Stufe wird verwendet, um das Dienstprojekt zu veröffentlichen, das in die letzte Phase kopiert werden soll.
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./Web8.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=true
